<html>
    ...
    <body>
        <div class="container">
            <div class="icon"><img src="<?php echo $this->getAssetsPathUrl('images/error/lock_icon.png');?>" /></div>
            <h1><?php echo __('Access Denied');?></h1>
            <p><?php echo $this->getMessage();?></p>
            <div class="btn-group">
                <a onclick="javascript:history.go(-1);" class="btn btn-magenta"><?php echo __("Go Back");?></a>
            </div>
        </div>
