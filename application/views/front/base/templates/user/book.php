...
<div class="book_appointment_avail_time">
			<h3><?php echo __('Select a Time');?></h3>
	...
	<div class="modal-content"> 
		...
		<div class="popup_form">
			...
			<li>
				...
				<span class="help-block"><?php echo __('Mention your name or family members to get appointment with this doctor.');?></span>
			...
			<li>
				...
				<span class="help-block"><?php echo __('Give your detail description about the appointment and reasons.');?></span>
...
<script>
    $(function(){
		...
		function loadTimeSlots(date) {
			addeddate = date;
			 $.ajax({
				...
				<p><?php echo __("You have booked on this time");?>.</p>\
				</div></li>'; 
							} else {
						...
						$.each(resp.slots.shift2, function(k,v){
							if (v.you_booked) {
								html += '<li class="you_booked_time"><a href="javascript:;" data-datetime="'+date+' '+v.time_24hr+'" data-time="'+v.time+'" title="'+v.time+'">'+v.time+'</a><div class="you_booked_time_info">\
				<p><?php echo __("You have booked on this time");?></p>\
				</div></li>'; 
		...
		$(document.body).on('click',".bookapt",function(){
			...
			var mon = moment($(this).attr('data-datetime'));
			var d = new Date(mon.get('year'),mon.get('month'),mon.get('date'),mon.get('hour'),mon.get('minute'),mon.get('second'));
